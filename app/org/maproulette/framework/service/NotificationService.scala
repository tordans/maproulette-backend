    ...
    val notificationType = isMetaReview match {
      ...
      case false =>
        reviewStatus match {
          ...
          case Task.REVIEW_STATUS_APPROVED_WITH_REVISIONS => UserNotification.NOTIFICATION_TYPE_REVIEW_APPROVED
          case Task.REVIEW_STATUS_APPROVED_WITH_FIXES_AFTER_REVISIONS => UserNotification.NOTIFICATION_TYPE_REVIEW_APPROVED
