  ...
  def getReviewerLeaderboard(
    ...
    val query = Query.simple(
      ...
      base = s"""
        ...
        ${this.reviewStatusSumSQL(Task.REVIEW_STATUS_APPROVED_WITH_REVISIONS)} AS reviews_approved_with_revisions,
        ${this.reviewStatusSumSQL(Task.REVIEW_STATUS_APPROVED_WITH_FIXES_AFTER_REVISIONS)} AS reviews_approved_with_fixes_after_revisions,
