...
object Task extends CommonField {
  ...
  val REVIEW_STATUS_APPROVED_WITH_REVISION = 6
  val REVIEW_STATUS_APPROVED_WITH_REVISION_NAME = "Approved With Revision"
  val REVIEW_STATUS_APPROVED_WITH_FIXES_AFTER_REVISION = 7
  val REVIEW_STATUS_APPROVED_WITH_FIXES_AFTER_REVISION_NAME = "Approved With Fixes After Revision"
  ...
  val reviewStatusMap = Map(
    ...
    REVIEW_STATUS_APPROVED_WITH_REVISION -> REVIEW_STATUS_APPROVED_WITH_REVISION_NAME,
    REVIEW_STATUS_APPROVED_WITH_FIXES_AFTER_REVISION -> REVIEW_STATUS_APPROVED_WITH_FIXES_AFTER_REVISION_NAME
  )
